            ...
            <div className="h-full p-3 flex flex-col gap-2">
              ...
              {!locked && (
                <div className="flex gap-2 text-xs">
                  ...
                  >
                    <SelectTrigger className="h-6 text-xs flex-1 bg-[#32CD32] !text-white [&>span]:!text-white [&_svg]:!text-white" data-testid={`select-winner-dest-${matchup.id}`}>
                  ...
                  >
                    <SelectTrigger className="h-6 text-xs flex-1 bg-[#c92e2f] !text-white [&>span]:!text-white [&_svg]:!text-white" data-testid={`select-loser-dest-${matchup.id}`}>
                      <SelectValue placeholder="Moves to" />
                    </SelectTrigger>
                    <SelectContent>
                      <SelectItem value="unassigned">Moves to</SelectItem>
