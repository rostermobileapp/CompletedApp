...
export function LineManager({ teamId, isTeamCaptain, teamMembers }: LineManagerProps) {
  ...
  const renderPosition = (lineCombination: LineCombination, position: string) => {
    ...
    return (
      <div
        key={position}
        className="relative border-2 border-dashed rounded-lg p-4 min-h-[40px] flex flex-col items-center justify-center transition-colors hover:border-primary/50 pt-[2px] pb-[2px] pl-[2px] pr-[2px]"
  ...
  return (
    <Card>
      ...
      <CardContent className="p-6 space-y-6 pl-[12px] pr-[12px] pt-[4px] pb-[4px]">
        {/* Available Players */}
        {isTeamCaptain && (
          <div>
