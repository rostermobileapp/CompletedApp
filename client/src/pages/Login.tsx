...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-black flex flex-col overflow-hidden" data-testid="login-page">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 text-[#1161f4] bg-[1161f4]">
        <motion.div
            ...
            {!showForm && (
              ...
              >
                <button
                  ...
                  className="px-12 py-6 text-lg font-semibold bg-transparent border-none min-h-[52px] text-[#1161f4]"
