...
{canAccessPremiumFeatures() ? (
      ...
      {selectedConversation && !canAccessPremiumFeatures() && (
        <div className="bg-background border-t border-border p-4 pb-20" data-testid="message-input-locked">
      ...
      {selectedConversation && canAccessPremiumFeatures() && (
        <div className="bg-background border-t border-border p-4 pb-20" data-testid="message-input-container">
          {/* File previews */}
