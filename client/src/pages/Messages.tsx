...
{canAccessPremiumFeatures() ? (
      ...
      {selectedConversation && !canAccessPremiumFeatures() && (
        <div className="fixed left-0 right-0 bg-background border-t border-border p-4 z-[60] bottom-0 pb-[env(safe-area-inset-bottom,0px)]" data-testid="message-input-locked">
      ...
      {selectedConversation && canAccessPremiumFeatures() && (
        <div className="fixed left-0 right-0 bg-background border-t border-border p-4 z-[60] bottom-0 pb-[env(safe-area-inset-bottom,0px)]" data-testid="message-input-container">
          {/* File previews */}
