        ...
        {screen === 'social_proof' && (
          <div className="pt-6">
            <div className="text-center mb-8">
              <h2 className="text-2xl font-black text-gray-900 mb-2">What users are saying:</h2>
            </div>
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="bg-gray-50 rounded-2xl p-5 border border-gray-200">
                ...
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-full bg-gray-300 text-white flex items-center justify-center text-sm font-bold">J</div>
                  <div>
                    <p className="text-sm font-semibold text-gray-900">Jamie R.</p>
                    <p className="text-xs text-gray-400">Team captain · Wednesday night hockey</p>
                  </div>
                </div>
              </div>
            </div>
...
function PaywallScreen({ onSignUp, onSkip }: { onSignUp: () => void; onSkip: () => void }) {
  return (
    <div className="pt-8 pb-4">
      ...
      {/* Testimonial */}
      <div className="bg-gradient-to-br from-[#3c82f4]/5 to-blue-50 rounded-2xl p-4 border border-[#3c82f4]/20 mb-6">
        <div className="flex gap-0.5 mb-2">
          {[...Array(5)].map((_, i) => <Star key={i} className="w-3.5 h-3.5 fill-yellow-400 text-yellow-400" />)}
        </div>
        <p className="text-sm text-gray-700 font-medium italic mb-2">"I've had different leagues use different apps and Roster is the best BY FAR"</p>
        <p className="text-xs text-gray-400">— Scott C., Hockey player</p>
      </div>
