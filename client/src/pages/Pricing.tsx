...
const featureRows = [
  ...
  { label: "RSVP Alerts", free: true, pro: true, comm: true, bench: true },
  ...
  { label: "In-App Payments", free: false, pro: true, comm: true, bench: false },
  { label: "Player Substitution System", free: false, pro: true, comm: true, bench: false },
  ...
  { label: "League Stats & Standings", free: "team only", pro: true, comm: true, bench: true },
  { label: "League Announcements", free: false, pro: true, comm: true, bench: false },
  ...
  { label: "League Scheduling", free: false, pro: false, comm: true, bench: false },
  { label: "Scorekeeping", free: false, pro: false, comm: true, bench: false },
  { label: "Tournaments Mode", free: false, pro: false, comm: true, bench: false },
  { label: "Bracket Management", free: false, pro: false, comm: "soon", bench: false },
  { label: "Mobile App", free: true, pro: true, comm: true, bench: true },
  { label: "Website Portal", free: false, pro: true, comm: true, bench: false },
];
