...
export default function ReferralProgram() {
  ...
  const ORG_TYPES = ['Association', 'League', 'Team', 'Club'];
      ...
      <section className="py-20 px-6 bg-gradient-to-b from-blue-50/60 to-white text-center pt-[40px] pb-[40px]">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <button onClick={scrollToApply} className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full bg-[#3c82f4] text-white text-lg font-semibold hover:bg-[#3c82f4]/90 transition-colors shadow-lg shadow-blue-200">
              Apply to Become a Partner <ArrowRight className="w-5 h-5" />
            </button>
            <Link href="/referral-program/portal/login" className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full border border-gray-300 text-gray-700 text-lg font-semibold hover:border-gray-400 transition-colors">
              Partner Login
            </Link>
          </div>
        </div>
