  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <section className="py-20 px-6 bg-gradient-to-b from-blue-50/60 to-white text-center pt-[40px] pb-[40px]">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl font-black text-gray-900 leading-tight mb-5">
            We give back
            <br />
            <span className="text-[#3c82f4]">to the hockey community</span>
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                desc: 'Once approved, you will be a referral option for each user',
              },
              {
                step: '03',
                title: 'Earn',
                  desc: 'Every paid tier user who selects you as the referral source, earns 10% of the net revenue for you or your chosen cause - paid quarterly.',
              },
            ].map(item => (
      ...
      <section className="py-8 px-6 bg-white">
        <div className="max-w-5xl mx-auto">
          <div className="bg-white border border-gray-200 rounded-2xl p-7 shadow-sm flex flex-col justify-start">
      ...
      <section className="py-20 px-6 bg-white pt-[20px] pb-[20px]" id="payouts">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">Calculator</h2>
