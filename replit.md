...
- **Profile Career Stats**: The Profile page displays an aggregated stats card showing the user's career Goals, Assists, and Points across all leagues they're a member of. The card automatically pulls data from the stats system and only appears if the user has recorded at least one goal or assist.
