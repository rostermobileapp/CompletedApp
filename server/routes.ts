...
import { generateSingleElimination, generateDoubleElimination, generateRoundRobin, generateRoundRobinSplit, generateConsolation, generateThreeGameGuarantee, generateTripleElimination, generateCompassDraw, applyBracketType } from "./tournaments/bracketGenerator";
    ...
    try {
      ...
      switch (format) {
        ...
        case 'triple_elimination':
          bracketResult = generateTripleElimination(insertedTeams, tournamentId, settings);
          break;
        ...
        case 'consolation':
          ...
          break;
        case 'compass_draw':
          bracketResult = generateCompassDraw(insertedTeams, tournamentId, settings);
          break;
        case 'round_robin':
